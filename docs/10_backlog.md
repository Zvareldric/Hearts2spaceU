...
> **Status:** 🟢 Aktif · **Dibuat:** 2026-07-17 · **Diperbarui:** 2026-08-23
...
|------|-------|------|-----------|--------|----------------|---------|
| **B-001** | Reminders — notifikasi lokal opt-in per item Agenda | `feature` | 🔴 High | 📋 Ready | Organized Fandom Experience *(Enhanced Fandom Support)* | **Spec: [`reminders.md`](specs/reminders.md) — Sprint 12.** Penundaan tertulis tiga kali: [`agenda.md`](specs/agenda.md) §8, [`schedule.md`](specs/schedule.md) §2, [`voting-hub.md`](specs/voting-hub.md) §2 & §8 — bukti internal terkuat yang ada. Harganya beda kelas, dan spec mengoreksi perkiraannya: **dua** dependency baru, bukan satu (`flutter_local_notifications` menuntut `timezone`), izin `POST_NOTIFICATIONS` (Android 13+), otorisasi iOS, dan zona waktu yang menabrak asumsi zona waktu tunggal [`schedule.md`](specs/schedule.md) §4 — diselesaikan dengan **mewarisi** asumsi itu, bukan menggantinya. `buildAgenda` sudah menjawab "apa yang layak diingatkan" sebagai fungsi murni teruji, jadi sprintnya tinggal menangani lapisan platform dan satu keputusan baru: *kapan* mengingatkan. |
